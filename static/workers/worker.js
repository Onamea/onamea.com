...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Crypto_Ed25519.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/isNumber.ts
var isNumber_default = (value) => {
  return typeof value === "number" && !isNaN(value) && isFinite(value);
};

// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/isString.ts
var isString_default = (value) => {
  return typeof value === "string";
};

// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/CryptoNames.ts
var cryptoNames = [
  "Ed25519",
  "ECDSA",
  "Schnorr"
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/characters.json
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/characters.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/getUTF8StringLength.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/Base32.ts
var isBase32 = (value) => {
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/codec.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/isUint8Array.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/Hex.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Mnemonic.ts
var toMnemonicString = (mnemonic) => {
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/last.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/Hash.ts
var isHash = (value) => {
  return isHexString(value) && value.length === 64;
};

// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Crypto.ts
...
var generateKeyPair = (cryptoName, getPublicKey4, keygen3) => (mnemonicLength) => {
  if (mnemonicLength) {
    const mnemonic = generateMnemonic2(mnemonicLength);
    const mnemonicString = toMnemonicString(mnemonic);
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/toPrimaryKeyLength.ts
var toPrimaryKeyLength = (bytesLength) => {
  return toBase32Length(bytesLength) + 1;
};

// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/utils/toBuffer.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Crypto_ECDSA.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Crypto_Schnorr.ts
...
// deno:https://jsr.io/@vanice/types/0.2.0-alpha.13/lib/crypto/Cryptos.ts
var cryptos = {
...
var generateKeyPair5 = async (name, length) => {
  return await cryptos[name].generateKeyPair(length);
};
...
var generateKeyPair6 = async (cryptoName, shouldGenerateMnemonic = false, xPub, index) => {
  if (xPub !== void 0 && index !== void 0) {
    ...
    return await generateKeyPair5(cryptoName, shouldGenerateMnemonic ? 12 : void 0);
  }
};
...
worker.onmessage = async (event) => {
  ...
  while (match === false) {
    ...
    const { publicKey, privateKey, mnemonic } = await generateKeyPair6(cryptoName, shouldGenerateMnemonic, xPub, offset + totalAttempts);
